package com.example.owner.security.filter;

import com.example.owner.security.dto.UsernamePasswordAuthenticationRequest;
...
public class CustomUsernamePasswordAuthFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        Authentication authentication = new UsernamePasswordAuthenticationToken(authRequest.login(), authRequest.password());
